    ...
    <div style={{position:"fixed",inset:0,zIndex:400,display:"flex",alignItems:"center",justifyContent:"center",background:AUTH_BG,padding:16,fontFamily:"'DM Sans',sans-serif"}}>
      <form onSubmit={submit} style={{width:"100%",maxWidth:340,background:AUTH_CARD,border:"1px solid "+AUTH_BORDER,borderRadius:16,padding:28,display:"flex",flexDirection:"column",gap:14,boxShadow:"0 8px 30px rgba(0,0,0,0.08)"}}>
        <div style={{textAlign:"center",marginBottom:6}}>
          <img src={LOGO_B64} alt="DocWorks" style={{height:58,width:"auto",maxWidth:"220px",objectFit:"contain",filter:"drop-shadow(0 0 14px rgba(212,168,83,0.42))",marginBottom:8}}/>
...
function SesionBadge({ contexto, onLogout }){
  ...
  return (
    <div className="sesion-badge" style={{display:"flex",alignItems:"center",gap:10,fontSize:12,color:"var(--text)"}}>
      <span style={{fontWeight:600,maxWidth:240,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{usuario}</span>
...
function usePerfilSupabase(ctx, perfil, setPerfil){
  ...
  useEffect(function(){
    ...
    var t=setTimeout(function(){ loadSupabaseJs().then(function(sb){ if(sb) guardar(sb,perfil).catch(function(){}); }); },500);
    return function(){clearTimeout(t);};
  },[inmobId,perfil]);
}
...
export default function App(){
  ...
  usePerfilSupabase(docworksAuth.contexto, perfil, setPerfil);
