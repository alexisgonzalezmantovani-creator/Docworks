    ...
    <div>
      ...
      {tab==="cuenta"&&(
        <div style={{maxWidth:1080,margin:"0 auto"}}>
          <div className="cuenta-config-grid" style={{display:"grid",gridTemplateColumns:"240px minmax(0,1fr)",gap:14,alignItems:"start"}}>
            <div style={{
              background:"linear-gradient(180deg,rgba(212,168,83,0.10),rgba(212,168,83,0.025))",
              border:"1px solid rgba(212,168,83,0.20)",borderRadius:16,padding:"18px 16px 16px",textAlign:"center",
              boxShadow:"0 10px 24px rgba(0,0,0,.07)"
            }}>
              <div style={{width:74,height:74,borderRadius:16,background:"rgba(255,255,255,.78)",border:"1px solid rgba(212,168,83,.30)",margin:"0 auto 10px",display:"flex",alignItems:"center",justifyContent:"center",overflow:"hidden",boxShadow:"0 8px 18px rgba(0,0,0,.10)"}}>
              ...
              <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:0,margin:"14px auto 0",paddingTop:12,borderTop:"1px solid var(--border)"}}>
