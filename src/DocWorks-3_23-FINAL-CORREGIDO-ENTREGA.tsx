...
// DocWorks 3.23 FINAL — correcciones finales UX, documentos, montos y firmas.
...
const GS = `
  ...
  *{box-sizing:border-box;margin:0;padding:0;}
  ...
  .viewer-modal .modal-body{display:flex;flex-direction:column;min-height:0;overflow-y:auto;}
  .viewer-modal .doc-viewer-shell{min-height:0;display:flex;flex-direction:column;}
  .viewer-modal .doc-viewer-shell>*{flex-shrink:0;}
  .doc-header-actions{display:flex;align-items:center;justify-content:flex-end;gap:6px;flex-wrap:wrap;}
...
function DocumentHeaderActions({onEdit,onPDF,onDOCX,onShare}){
  return (
    <div className="doc-header-actions">
      <Btn v="secondary" s="sm" onClick={onEdit}><DWIcon name="edit" size={14}/> Editar</Btn>
      <Btn v="primary" s="sm" onClick={onPDF}>Descargar PDF</Btn>
      <Btn v="secondary" s="sm" onClick={onDOCX}>Descargar DOCX</Btn>
      <Btn v="secondary" s="sm" onClick={onShare}>Compartir documento</Btn>
    </div>
  );
}
...
export default function App(){
  ...
  return(
    <>
      ...
      <Modal open={!!viewDoc} onClose={function(){setViewDoc(null);setDocAutoAction(null);}} title={viewDoc?(viewDoc.inmueble_direccion||TIPOS[viewDoc.tipo]||"Documento"):"DocWorks"} wide={true} viewerMode={true}
