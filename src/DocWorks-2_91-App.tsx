  ...
  function CuentaDocumentoPreview(){
    ...
    return <div className="cuenta-doc-preview-wrap">
      ...
      <div className="cuenta-doc-page" style={{fontFamily:serif}}>
        {localPerfil.logoDataUrl&&<div className="cuenta-doc-logo-row" style={{textAlign:logoAlign}}><img src={localPerfil.logoDataUrl} style={{maxWidth:logoWidth,maxHeight:logoMaxH,width:"auto",height:"auto",objectFit:"contain"}} alt="Logo"/></div>}
        ...
        <div className="cuenta-doc-footer">
          ...
          {localPerfil.pie_pagina_logo_debajo&&localPerfil.logoDataUrl&&<div style={{textAlign:logoAlign,marginTop:5}}><img src={localPerfil.logoDataUrl} style={{height:24,width:"auto",objectFit:"contain"}} alt="Logo pie"/></div>}
        </div>
      </div>
    </div>;
  }
