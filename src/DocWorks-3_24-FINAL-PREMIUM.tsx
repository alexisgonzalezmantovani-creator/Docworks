...
const GS = `
  ...
  *{box-sizing:border-box;margin:0;padding:0;}
  ...
  .modal-overlay-viewer{overflow:auto!important;align-items:flex-start!important;padding-top:12px!important;padding-bottom:12px!important;}
  .viewer-modal{max-width:980px!important;width:min(980px,calc(100vw - 28px));height:auto;min-height:0;max-height:none;}
  ...
  .viewer-modal .modal-body{display:flex;flex-direction:column;min-height:0;overflow:visible!important;overflow-x:hidden;}
  ...
  .negociacion-panel{overflow:visible!important;max-height:none!important;}
  .negociacion-panel .reserva-decision-actions,.negociacion-panel .grid2{overflow:visible!important;max-height:none!important;}
  @media(max-width:640px){.op-detail-hero{align-items:stretch;flex-direction:column;}.op-detail-title{font-size:19px;}.doc-viewer-tabs{margin-left:-2px;margin-right:-2px;}
    .viewer-modal{width:100%!important;max-width:100%!important;height:auto!important;min-height:0!important;max-height:none!important;}
    .viewer-modal .modal-head{padding:12px 14px;}
    .viewer-modal .modal-title{max-width:46vw;}
            ...
            <div style={{padding:"20px 22px 22px"}}>
              <div style={{display:"grid",gridTemplateColumns:"minmax(250px,300px) minmax(0,1fr)",gap:22,alignItems:"start"}}>
                    ...
                    <div style={{width:92,height:92,borderRadius:15,background:"rgba(255,255,255,.90)",border:"1px solid rgba(212,168,83,.32)",display:"flex",alignItems:"center",justifyContent:"center",overflow:"hidden",boxShadow:"0 8px 20px rgba(0,0,0,.10)",flexShrink:0}}>
                      {localPerfil.logoDataUrl
                        ? <div style={{position:"relative",width:"100%",height:"100%",display:"flex",alignItems:"center",justifyContent:"center"}}>
                            ...
                            <button type="button" title="Quitar logo" onClick={function(){setLocalPerfil(function(p){return Object.assign({},p,{logoDataUrl:"",pie_pagina_logo_debajo:false});});}} style={{position:"absolute",top:-7,right:-7,width:22,height:22,borderRadius:"50%",background:"var(--red)",border:"2px solid var(--surface)",color:"white",cursor:"pointer",fontSize:11,fontWeight:700,display:"flex",alignItems:"center",justifyContent:"center",boxShadow:"0 4px 10px rgba(0,0,0,.18)"}}>×</button>
                          </div>
                ...
                <div className="cuenta-info-grid" style={{display:"grid",gridTemplateColumns:"repeat(3,minmax(0,1fr))",gap:"12px 14px",alignItems:"start"}}>
                  ...
                  <div style={{gridColumn:"span 2",display:"flex",justifyContent:"flex-end",alignItems:"stretch",minHeight:38,paddingTop:16}}>
                    <Btn v="success" onClick={savePerfil} style={{minWidth:190}} disabled={perfilSaveStatus==="saving"}>{perfilSaveStatus==="saving"?"Guardando…":"Guardar cambios ✓"}</Btn>
                  </div>
                </div>
              </div>
