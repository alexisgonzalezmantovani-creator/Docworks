      ...
      <div role="dialog" aria-modal="true" aria-label="Introducción a DocWorks" style={{width:"min(620px,100%)",border:"1px solid rgba(212,168,83,0.35)",borderRadius:24,background:"linear-gradient(145deg,rgba(16,25,43,0.98),rgba(8,14,26,0.99))",boxShadow:"0 30px 90px rgba(0,0,0,0.55),0 0 40px rgba(212,168,83,0.08)",overflow:"hidden"}}>
        ...
        <div style={{padding:"26px 28px 24px"}}>
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",gap:12,marginBottom:24}}>
            <div style={{display:"flex",alignItems:"center",gap:11}}>
              ...
              <div>
                ...
                <div style={{fontSize:12,color:"#cbd5e1",marginTop:3}}>Paso {step+1} de {steps.length}</div>
              </div>
            </div>
            <button type="button" onClick={function(){onClose(false);}} aria-label="Cerrar recorrido" style={{width:34,height:34,borderRadius:10,border:"1px solid rgba(255,255,255,0.20)",background:"rgba(255,255,255,0.04)",color:"#dbe5f1",cursor:"pointer",fontSize:18}}>×</button>
          </div>
          ...
          <div style={{minHeight:185}}>
            <h2 style={{margin:"0 0 12px",fontSize:27,lineHeight:1.15,color:"#f8fafc",letterSpacing:-.5}}>{current.title}</h2>
            <p style={{margin:0,fontSize:15,lineHeight:1.75,color:"#dbe5f1",maxWidth:540}}>{current.text}</p>
            {step===0&&<div style={{marginTop:20,padding:"12px 14px",borderRadius:12,background:"rgba(212,168,83,0.07)",border:"1px solid rgba(212,168,83,0.16)",fontSize:12.5,color:"#dbe5f1"}}>No necesitás memorizar nada. La idea es que puedas empezar a trabajar y volver a esta guía cuando quieras.</div>}
            {step===steps.length-1&&<div style={{marginTop:20,padding:"12px 14px",borderRadius:12,background:"rgba(91,198,125,0.07)",border:"1px solid rgba(91,198,125,0.16)",fontSize:12.5,color:"#dbe5f1"}}>Tip: el recorrido queda disponible desde el botón <strong style={{color:"#f8fafc"}}>?</strong> de la barra superior.</div>}
          </div>
          ...
          <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",gap:10,marginTop:18}}>
            ...
            <div style={{display:"flex",gap:9}}>
              {step>0&&<button type="button" onClick={retroceder} style={{height:42,padding:"0 17px",borderRadius:11,border:"1px solid rgba(255,255,255,0.20)",background:"rgba(255,255,255,0.04)",color:"#f8fafc",fontWeight:600,cursor:"pointer"}}>Anterior</button>}
