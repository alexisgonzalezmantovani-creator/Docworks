...
// DocWorks 3.0 — personalización amigable del texto de PRECIO + activación de
...
function EstadisticasView({operaciones,equipo,perfil}){
  ...
  var comisiones=operacionesRaiz.map(function(o){var c=comisionOperacion(o);var split=splitMode==="individual"&&o.broker_id&&splitMap[o.broker_id]!=null?Math.max(0,Math.min(100,parseFloat(splitMap[o.broker_id])||0)):splitBroker;var brokerShare=o.broker_id?c.monto*split/100:0;return Object.assign({op:o,brokerShare:brokerShare,inmobiliariaShare:c.monto-brokerShare,brokerSplit:split},c);});
      ...
      {tab==="equipo"&&(
        <div>
          ...
          <div style={{background:"linear-gradient(135deg,rgba(212,168,83,.07),transparent)",border:"1px solid rgba(212,168,83,.18)",borderRadius:16,padding:"16px 18px",marginBottom:20}}>
            ...
            <div style={{display:"grid",gridTemplateColumns:"minmax(0,1fr) 170px",gap:12,alignItems:"end"}}>
