...
function SesionBadge({ contexto, onLogout }){
  ...
  return (
    <div className="sesion-badge" style={{position:"fixed",bottom:10,left:10,zIndex:250,display:"flex",alignItems:"center",gap:8,background:AUTH_CARD,border:"1px solid "+AUTH_BORDER,borderRadius:20,padding:"6px 10px",fontSize:11.5,color:AUTH_TEXT,boxShadow:"0 2px 10px rgba(0,0,0,0.08)"}}>
