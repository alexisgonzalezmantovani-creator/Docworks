...
const GS = `
  ...
  *{box-sizing:border-box;margin:0;padding:0;}
  ...
  :root{
    ...
    --mobile-nav-h:60px;
    /* Superficies "neutras" (inputs, botones secundarios, hovers) que antes
       estaban hardcodeadas en rgba(255,255,255,x) — pensadas solo para fondo
       oscuro. Ahora dependen del tema y se recalculan en applyTheme(). */
  ...
  .topbar-avatar{width:50px;height:50px;border-radius:50%;background:var(--gold);display:flex;align-items:center;justify-content:center;font-size:14px;color:#0a0f1a;font-weight:700;cursor:pointer;overflow:hidden;border:2px solid rgba(212,168,83,0.4);}
  ...
  /* ── Navegación Premium ── */
   ...
   .sidebar .nav-item.active{background:linear-gradient(145deg,rgba(212,168,83,.16),rgba(212,168,83,.05));border-color:rgba(212,168,83,.42);box-shadow:0 6px 18px rgba(212,168,83,.12),inset 0 0 0 1px rgba(255,255,255,.025);}
  ...
  .btn-secondary{background:var(--surface2);color:var(--text);border:1px solid var(--border2);padding:7px 14px;}
  ...
  .inp{width:100%;padding:10px 12px;background:var(--input-bg);border:1px solid var(--input-border);border-radius:9px;color:var(--text);font-family:'DM Sans',sans-serif;font-size:16px;outline:none;transition:all 0.15s;}
  .inp::placeholder{color:var(--dim);}
  .inp:focus{border-color:rgba(212,168,83,0.6);background:rgba(212,168,83,0.05);box-shadow:0 0 0 3px rgba(212,168,83,0.1);}
  .inp:hover:not(:focus){border-color:var(--dim);}
  ...
  .modal-close{background:var(--surface2);border:1px solid var(--border);border-radius:8px;width:32px;height:32px;display:flex;align-items:center;justify-content:center;cursor:pointer;color:var(--muted);font-size:15px;transition:all 0.15s;flex-shrink:0;}
