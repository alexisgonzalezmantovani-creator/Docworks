      ...
      {tab==="plantillas"&&(function(){
        ...
        function ClauseCard({c,index}){
          ...
          return <div key={c.id}
            ...
            onDragOver={function(e){if(draggable)e.preventDefault();}}
            ...
            <div style={{width:30,height:30,borderRadius:9,background:"rgba(212,168,83,.09)",border:"1px solid rgba(212,168,83,.16)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:10.5,fontWeight:700,color:"var(--gold)",flexShrink:0}}>{index+1}</div>
            ...
            {puedeAgregar&&<button onClick={function(){quitarClausula(c.id);}} style={{height:29,padding:"0 9px",borderRadius:7,border:"1px solid rgba(248,113,113,.16)",background:"rgba(248,113,113,.05)",color:"var(--red)",cursor:"pointer",fontSize:10.2}}>Quitar</button>}
        ...
        return <div>
          <div className="card" style={{padding:13,marginBottom:10}}>
            <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",gap:12,flexWrap:"wrap"}}>
              <div><div style={{fontFamily:"DM Serif Display,serif",fontSize:18,color:"var(--text)"}}>Plantillas</div><div style={{fontSize:10.9,color:"var(--dim)",marginTop:3}}>Cada plantilla es un documento completo armado con cláusulas reutilizables.</div></div>
          ...
          <div style={{display:"grid",gridTemplateColumns:"minmax(210px,.72fr) minmax(0,1.7fr)",gap:10,alignItems:"start"}}>
            ...
            <div>
              ...
              <div className="card" style={{padding:13,marginBottom:9}}>
                ...
                <div style={{fontSize:10.5,color:"var(--dim)",lineHeight:1.5,margin:"9px 0 11px"}}>La plantilla define qué cláusulas lleva el documento y en qué orden. Las cláusulas siguen viviendo en la Biblioteca y pueden reutilizarse en otras plantillas.</div>
                ...
                {puedeAgregar&&<div style={{marginTop:12,paddingTop:11,borderTop:"1px solid var(--border)"}}>
                  ...
                  <div style={{display:"flex",gap:7,alignItems:"center"}}>
                    <select className="inp" style={{flex:1,minWidth:0}} defaultValue="" onChange={function(e){if(e.target.value){agregarClausula(e.target.value);e.target.value="";}}}><option value="">Seleccioná una cláusula de la Biblioteca…</option>{disponibles.map(function(c){return <option key={c.id} value={c.id}>{c.titulo||"Todo OK"}{CLAUSULAS_DEFAULT.find(function(d){return d.id===c.id;})?" · Estándar":" · Propia"}</option>;})}</select>
