  ...
  function CuentaDocumentoPreview(){
    ...
    return <div className="cuenta-doc-preview-wrap">
      ...
      <div className="cuenta-doc-page" style={{fontFamily:serif}}>
        {localPerfil.logoDataUrl&&<div className="cuenta-doc-logo-row" style={{textAlign:"left"}}><img src={localPerfil.logoDataUrl} style={{display:"block",marginLeft:logoAlign==="izquierda"?0:logoAlign==="centro"?"auto":undefined,marginRight:logoAlign==="derecha"?0:logoAlign==="centro"?"auto":"auto",maxWidth:logoWidth,maxHeight:logoMaxH,width:"auto",height:"auto",objectFit:"contain"}} alt="Logo"/></div>}
        ...
        <div className="cuenta-doc-footer">
          ...
          <div className="cuenta-doc-footer-row"><span>{localPerfil.nombre||"Tu inmobiliaria"}</span><span>Página 1</span></div>
          {localPerfil.pie_pagina_texto&&<div className="cuenta-doc-footer-note">{localPerfil.pie_pagina_texto}</div>}
          {localPerfil.pie_pagina_logo_debajo&&localPerfil.logoDataUrl&&<div style={{textAlign:"left",marginTop:5}}><img src={localPerfil.logoDataUrl} style={{display:"block",height:Math.max(12,Math.min(58,24*(localPerfil.pie_pagina_logo_scale||100)/100)),width:"auto",objectFit:"contain",marginLeft:logoAlign==="izquierda"?0:logoAlign==="centro"?"auto":undefined,marginRight:logoAlign==="derecha"?0:logoAlign==="centro"?"auto":"auto"}} alt="Logo pie"/></div>}
        </div>
      </div>
    </div>;
  }
        ...
        <div style={{maxWidth:980,margin:"0 auto"}}>
          ...
          <div className="card" style={{padding:"22px 22px 20px"}}>
            ...
            <div style={{display:"grid",gridTemplateColumns:"repeat(2,minmax(0,1fr))",gap:"12px 14px",alignItems:"start"}}>
              ...
              <div style={{gridColumn:"1 / -1"}}><Txa label="Descripción / Slogan" value={localPerfil.descripcion||""} onChange={fP("descripcion")} placeholder="Breve descripción que aparece en documentos..." rows={2}/></div>
            ...
            {entries.map(function(en){
              ...
              return <div key={en.id} className="card" style={{padding:"10px 12px",borderColor:abierta?"rgba(212,168,83,.30)":"var(--border)"}}>
                ...
                {abierta&&cambios.length>0&&<div style={{marginTop:10,paddingTop:10,borderTop:"1px solid var(--border)"}}>
                  <div style={{fontSize:9.5,fontWeight:700,color:"var(--dim)",textTransform:"uppercase",letterSpacing:".08em",marginBottom:7}}>Cambio realizado</div>
                  <div style={{display:"flex",flexDirection:"column",gap:6}}>
                    {cambios.map(function(c,i){return <div key={i} style={{borderRadius:9,border:"1px solid var(--border2)",overflow:"hidden",background:"rgba(255,255,255,.012)"}}>
                      <div style={{padding:"7px 9px",fontSize:10.8,fontWeight:700,color:"var(--text)",background:"rgba(148,163,184,.035)",borderBottom:"1px solid var(--border2)"}}>{c.label}</div>
                      <div style={{display:"grid",gridTemplateColumns:"minmax(0,1fr) minmax(0,1fr)",gap:0}}>
                        <div style={{padding:"8px 9px",borderRight:"1px solid var(--border2)"}}><div style={{fontSize:8.5,textTransform:"uppercase",letterSpacing:".07em",color:"var(--red)",marginBottom:4}}>Antes</div>{cajaValor(c.antes,!c.antes)}</div>
                        <div style={{padding:"8px 9px"}}><div style={{fontSize:8.5,textTransform:"uppercase",letterSpacing:".07em",color:"var(--green)",marginBottom:4}}>Después</div>{cajaValor(c.despues,!c.despues)}</div>
                      </div>
                    </div>})}
                  </div>
                </div>}
