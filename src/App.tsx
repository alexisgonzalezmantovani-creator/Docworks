...
function ReservaBloquesPanel({bloques, onUpdate, onMove, clausulasLib, operaciones, puedeEditar}){
  ...
  // La vista de control es auxiliar: nunca debe impedir abrir Plantillas si un dato
  // viejo o un bloque incompleto no puede ser comparado.
  ...
  return (
    <div style={{marginBottom:20}}>
      ...
      {/* Comparación y vista previa: aisladas para que un bloque legado no pueda
          romper la apertura de Plantillas. */}
      <div style={{marginTop:18,paddingTop:14,borderTop:"1px dashed var(--border2)"}}>
        <div style={{display:"flex",alignItems:"center",gap:7,marginBottom:8}}>
          <span style={{fontSize:14}}>🧪</span>
          <p style={{fontFamily:"DM Serif Display,serif",fontSize:14,color:"var(--text)",margin:0}}>Vista de control del documento</p>
        </div>
        {comparacion.error ? (
