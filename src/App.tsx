            ...
            <div style={{marginTop:14}}>
                  ...
                  <div style={{display:"flex",flexDirection:"column",gap:10}}>
                    ...
                    <div style={{border:"1px solid var(--border)",borderRadius:10,padding:11,background:"rgba(255,255,255,.012)"}}>
                      ...
                      <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",gap:8,marginBottom:5,flexWrap:"wrap"}}><div style={{fontSize:11.8,fontWeight:650,color:"var(--text)"}}>Texto de la introducción</div><span className="badge" style={{background:customTextoPreview?"rgba(212,168,83,.10)":"rgba(74,222,128,.08)",color:customTextoPreview?"var(--gold)":"var(--green)"}}>{customTextoPreview?"Personalizado":"Predeterminado"}</span></div>
                      ...
                      {!encabezadoEditing&&<div style={{marginTop:6,padding:"9px 10px",borderRadius:8,background:"rgba(255,255,255,.025)",border:"1px solid var(--border2)",fontSize:10.8,color:"var(--muted)",lineHeight:1.5}}>{customTextoPreview||"Se usa la introducción predeterminada de DocWorks (incluye datos de las partes y del inmueble). Si la reemplazás por un texto corto como “Documento de prueba”, se pierde el preámbulo legal completo."}</div>}
                    </div>
