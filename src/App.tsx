          ...
          <div style={{display:"grid",gridTemplateColumns:"minmax(210px,.72fr) minmax(0,1.7fr)",gap:10,alignItems:"start"}}>
            <div className="card" style={{padding:9}}>
              ...
              <div style={{display:"flex",flexDirection:"column",gap:4}}>
                {PLANTILLA_TIPOS.map(function(tipo){
                  ...
                  return <button key={tipo} onClick={function(){setTipoDocSel(tipo);setPlantillaForm(null);setDragClausulaId(null);setEncabezadoEditing(false);}} style={{display:"flex",alignItems:"center",justifyContent:"space-between",gap:8,width:"100%",border:active?"1px solid rgba(212,168,83,.25)":"1px solid transparent",borderRadius:9,padding:"9px 10px",background:active?"rgba(212,168,83,.10)":"transparent",color:active?"var(--text)":"var(--muted)",cursor:"pointer",textAlign:"left"}}>
            ...
            <div>
              ...
              <div className="card" style={{padding:13}}>
                <details>
                  <summary style={{fontSize:12.2,fontWeight:650,color:"var(--text)",cursor:"pointer"}}>Configuración del documento</summary>
                  <div style={{marginTop:10}}>
                    <div style={{fontSize:10.7,color:"var(--dim)",marginBottom:8}}>Vista previa del encabezado para {TIPOS[tipoDocSel]}.</div>
