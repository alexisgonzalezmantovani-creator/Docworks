      ...
      <div className="app-wrap">
        ...
        <div className="topbar">
          ...
          <div className="topbar-right">
            {perfil&&perfil.logoDataUrl&&<div className="topbar-inmob" title={perfil.nombre||"Inmobiliaria"}>
              <img src={perfil.logoDataUrl} alt={perfil.nombre||"Logo de la inmobiliaria"}/>
