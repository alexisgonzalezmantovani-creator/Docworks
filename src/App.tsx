...
// DocWorks 3.60 PRO — edición profesional, correcciones de operaciones, comisiones, documentos, móvil y cláusulas.
// DocWorks 3.60 PRO — IA asistida con dictado por voz, revisión inteligente, búsqueda ampliada, cláusulas obligatorias y experiencia 100% en español.
                  ...
                  <div style={{display:"flex",alignItems:"center",gap:12}}>
                    <div style={{position:"relative",width:72,height:72,flexShrink:0}}>
                      <div style={{width:72,height:72,borderRadius:"50%",background:"linear-gradient(145deg,var(--gold),var(--gold2))",border:"2px solid rgba(255,255,255,.18)",display:"flex",alignItems:"center",justifyContent:"center",overflow:"hidden",fontSize:22,fontWeight:800,color:"#0a0f1a"}}>
                        {(localPerfil.broker_fotos&&currentUserId&&localPerfil.broker_fotos[currentUserId])?<img src={localPerfil.broker_fotos[currentUserId]} style={{width:"100%",height:"100%",objectFit:"cover"}} alt="Foto de perfil"/>:((localPerfil.nombre||"Usuario").charAt(0).toUpperCase())}
                      </div>
