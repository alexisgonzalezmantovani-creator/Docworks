              ...
              return(
                <div key={c.id} className="op-card">
                  <div style={{display:"flex",alignItems:"flex-start",justifyContent:"space-between",gap:8}}>
                    ...
                    {editable&&(
                      <div style={{display:"flex",gap:3,flexShrink:0}}>
                        <button onClick={function(){setEditId(c.id);setForm({titulo:c.titulo,categoria:c.categoria,contenido:c.contenido,tipos:c.tipos||["todos"]});}} style={{padding:"4px 7px",borderRadius:6,background:"rgba(255,255,255,0.04)",border:"1px solid var(--border)",color:"var(--muted)",cursor:"pointer",fontSize:12,display:"inline-flex",alignItems:"center",justifyContent:"center"}}><DWIcon name="edit" size={14}/></button>
        ...
        title={
          renombrando ? (
            ...
            <span style={{display:"inline-flex",alignItems:"center",gap:8}}>
              ...
              <button title="Renombrar" onClick={function(){setRenombrando(true);}} style={{background:"transparent",border:"none",cursor:"pointer",fontSize:13,opacity:0.6,padding:2}}><DWIcon name="edit" size={14}/></button>
            </span>
          )
        }>
