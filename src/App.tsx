...
async function generarPDF(doc, logoDataUrl, perfil) {
  try {
    ...
    function drawParagraph(prefixRuns, bodyText, opts){
      ...
      var maxW=W-ML-MR;
      // Rótulo en negrita: termina en ":" SIN espacio final.
      // El espacio se dibuja aparte (fuente regular) y se avanza curX de forma
      // explícita. Así nunca queda "PRECIO:El" aunque el visor ignore espacios
      // al final de un Tj en negrita.
