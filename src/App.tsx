        ...
        return <div>
          ...
          {plantillaVista==="aspecto"&&<div className="card" style={{padding:18}}>
            ...
            <div style={{display:"grid",gridTemplateColumns:"minmax(0,1fr) minmax(300px,420px)",gap:14,alignItems:"start"}}>
              ...
              <div className="card" style={{padding:14}}><div style={{fontSize:13.5,fontFamily:"DM Serif Display,serif",color:"var(--text)",marginBottom:3}}>Vista previa en tiempo real</div><div style={{fontSize:10.5,color:"var(--dim)",marginBottom:10}}>Elegí cualquier documento como ejemplo visual.</div><CuentaDocumentoPreview/></div>
            </div>
