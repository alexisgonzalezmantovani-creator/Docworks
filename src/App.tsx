          ...
          <div style={{display:"grid",gridTemplateColumns:"minmax(210px,.72fr) minmax(0,1.7fr)",gap:10,alignItems:"start"}}>
            ...
            <div>
              ...
              <div className="card" style={{padding:13}}>
                ...
                {configuracionPlantillaAbierta&&<div style={{marginTop:10}}>
                  <div style={{fontSize:10.7,color:"var(--dim)",marginBottom:8}}>Vista previa y configuración avanzada para {TIPOS[tipoDocSel]}.</div>
