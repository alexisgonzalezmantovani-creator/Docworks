...
const GS = `
  ...
  *{box-sizing:border-box;margin:0;padding:0;}
  ...
  .viewer-modal{max-width:920px!important;width:min(920px,calc(100vw - 28px));height:auto;min-height:0;max-height:none;}
  .viewer-modal .modal-head{background:linear-gradient(135deg,#0f2a52,#123b72);border-bottom-color:rgba(96,165,250,.28);flex-wrap:nowrap!important;gap:10px;}
  ...
  .viewer-modal .doc-viewer-shell>*{flex-shrink:0;max-width:100%;}
    ...
    <div className="doc-summary-panel">
      <div className="op-detail-hero">
        ...
        <div style={{display:"flex",alignItems:"center",gap:7,flexShrink:0,flexWrap:"wrap",justifyContent:"flex-end"}}>
          <Btn v="secondary" s="sm" onClick={function(){setShowFicha(true);}}>👤 Ver ficha completa</Btn>
...
function getDocTabs(op){
  ...
  var TABS_BARRA=[TAB_RESUMEN].concat(TABS);
            ...
            <div style={{padding:"20px 22px 22px"}}>
              <div style={{display:"grid",gridTemplateColumns:"minmax(250px,300px) minmax(0,1fr)",gap:22,alignItems:"start"}}>
                    ...
                    <div style={{width:92,height:92,borderRadius:15,background:"rgba(255,255,255,.90)",border:"1px solid rgba(212,168,83,.32)",display:"flex",alignItems:"center",justifyContent:"center",overflow:"hidden",boxShadow:"0 8px 20px rgba(0,0,0,.10)",flexShrink:0}}>
                      {localPerfil.logoDataUrl
                        ? <div style={{position:"relative",width:"100%",height:"100%",display:"flex",alignItems:"center",justifyContent:"center"}}>
                            ...
                            <button type="button" title="Quitar logo" aria-label="Quitar logo" onClick={function(){setLocalPerfil(function(p){return Object.assign({},p,{logoDataUrl:"",pie_pagina_logo_debajo:false});});}} style={{position:"absolute",top:6,right:6,width:22,height:22,borderRadius:"50%",background:"rgba(18,26,40,.92)",border:"1px solid rgba(255,255,255,.78)",color:"#fff",cursor:"pointer",fontSize:13,lineHeight:1,fontWeight:700,display:"flex",alignItems:"center",justifyContent:"center",boxShadow:"0 3px 10px rgba(0,0,0,.24)",zIndex:3}}>×</button>
                          </div>
                ...
                <div className="cuenta-info-grid" style={{display:"grid",gridTemplateColumns:"repeat(3,minmax(0,1fr))",gap:"12px 14px",alignItems:"start"}}>
                  ...
                  <div style={{gridColumn:"span 2",display:"flex",justifyContent:"flex-start",alignItems:"stretch",minHeight:38,paddingTop:16}}>
                    <Btn v="success" onClick={savePerfil} style={{minWidth:150}} disabled={perfilSaveStatus==="saving"}>{perfilSaveStatus==="saving"?"Guardando…":"Guardar cambios ✓"}</Btn>
                  </div>
                </div>
              </div>
