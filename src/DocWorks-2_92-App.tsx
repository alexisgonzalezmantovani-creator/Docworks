            ...
            <div className="card" style={{padding:9}}>
              ...
              <div style={{display:"flex",flexDirection:"column",gap:4}}>
                {PLANTILLA_TIPOS.map(function(tipo){
                  ...
                  return <button key={tipo} onClick={function(){setTipoDocSel(tipo);setPlantillaSubtab("aspecto");setPlantillaForm(null);setDragClausulaId(null);setEncabezadoEditing(false);setConfiguracionPlantillaAbierta(false);setMostrarPreviewConfiguracion(false);setMostrarBloquesConfiguracion(false);}} style={{display:"flex",alignItems:"center",justifyContent:"space-between",gap:8,width:"100%",border:active?"1px solid rgba(212,168,83,.25)":"1px solid transparent",borderRadius:9,padding:"9px 10px",background:active?"rgba(212,168,83,.10)":"transparent",color:active?"var(--text)":"var(--muted)",cursor:"pointer",textAlign:"left"}}>
            ...
            <div>
              ...
              <div className="card" style={{padding:13,marginBottom:9}}>
                <div style={{display:"flex",gap:6,borderBottom:"1px solid var(--border)",marginBottom:12}}>
                  ...
                  <button type="button" onClick={function(){setPlantillaSubtab("aspecto");}} style={{flex:1,border:0,borderBottom:plantillaSubtab==="aspecto"?"2px solid var(--gold)":"2px solid transparent",background:"transparent",color:plantillaSubtab==="aspecto"?"var(--text)":"var(--muted)",padding:"9px 8px",cursor:"pointer",fontSize:11.5,fontWeight:plantillaSubtab==="aspecto"?700:500}}>Aspecto del documento</button>{tipoDocSel==="reserva"&&<button type="button" onClick={function(){setPlantillaSubtab("reserva");}} style={{flex:1,border:0,borderBottom:plantillaSubtab==="reserva"?"2px solid var(--gold)":"2px solid transparent",background:"transparent",color:plantillaSubtab==="reserva"?"var(--text)":"var(--muted)",padding:"9px 8px",cursor:"pointer",fontSize:11.5,fontWeight:plantillaSubtab==="reserva"?700:500}}>Cuerpo de Reserva</button>}
                </div>
