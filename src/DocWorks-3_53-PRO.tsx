  ...
  function iniciar(){
    ...
    try{
      ...
      rec.onerror=function(e){
        ...
        if(code!=="aborted") setError(code==="not-allowed"?"El navegador no tiene permiso para usar el micrófono.":"No se pudo usar el dictado.");
        setEscuchando(false);
      };
...
// DocWorks 3.53 PRO — edición premium, visor unificado, IA asistida, dictado por voz, revisión inteligente y estabilidad.
// DocWorks 3.53 PRO — IA asistida con dictado por voz, revisión inteligente, búsqueda ampliada y cláusulas obligatorias visibles.
          ...
          return (
            <div key={c.id} style={{marginBottom:8}}>
              <div style={{fontWeight:600,color:"#1f2937"}}>
                ...
                {c.obligatoria && <span style={{marginLeft:6,fontSize:9.5,color:"#b45309"}}>🔒 OBLIGATORIA · Definida por Dueño/Administrador de {nombreInmobiliariaObligatoria}</span>}
              </div>
...
function DocumentViewer({op,clausulas,perfil,operaciones,bloquesReserva,onToggleTarea,onUpdateOperation,onActionWorkflow,tab,onChangeTab,autoAction,onAutoActionDone}){
  ...
  async function ejecutarRevisionIA(){
    ...
    try{
      ...
      setAiReview({loading:false,text:"",error:(e&&e.message)||"No se pudo ejecutar la revisión con IA."});
    }
  }
  ...
  return(
    <div style={{display:"flex",flexDirection:"column",gap:10}}>
      ...
      <label style={{display:"flex",alignItems:"flex-start",gap:8,padding:"9px 11px",borderRadius:8,border:"1px solid var(--border)",background:form.obligatoria?"rgba(180,83,9,0.08)":"transparent",cursor:"pointer",fontSize:12.5,color:"var(--text)"}}>
        ...
        <span>🔒 <b>OBLIGATORIA</b> — La define el Dueño/Administrador de la inmobiliaria y el broker no podrá quitarla de esta operación.</span>
      </label>
      <div>
