            ...
            <div className="card" style={{padding:9}}>
              ...
              <div style={{display:"flex",flexDirection:"column",gap:4}}>
                {PLANTILLA_TIPOS.map(function(tipo){
                  ...
                  return <button key={tipo} onClick={function(){setTipoDocSel(tipo);setPlantillaForm(null);setDragClausulaId(null);setEncabezadoEditing(false);setConfiguracionPlantillaAbierta(false);}} style={{display:"flex",alignItems:"center",justifyContent:"space-between",gap:8,width:"100%",border:active?"1px solid rgba(212,168,83,.25)":"1px solid transparent",borderRadius:9,padding:"9px 10px",background:active?"rgba(212,168,83,.10)":"transparent",color:active?"var(--text)":"var(--muted)",cursor:"pointer",textAlign:"left"}}>
            ...
            <div>
              ...
              <div className="card" style={{padding:13}}>
                ...
                {configuracionPlantillaAbierta&&<div style={{marginTop:12,display:"flex",flexDirection:"column",gap:10}}>
                  ...
                  {/* VISTA PREVIA */}
                  <div style={{border:"1px solid var(--border)",borderRadius:10,padding:11,background:"rgba(255,255,255,.012)"}}>
                    <div style={{fontSize:11.8,fontWeight:650,color:"var(--text)",marginBottom:5}}>Vista previa</div>
                  ...
                  {tipoDocSel==="reserva"&&<div style={{border:"1px solid var(--border)",borderRadius:10,padding:11,background:"rgba(255,255,255,.012)"}}>
                    <div style={{fontSize:11.8,fontWeight:650,color:"var(--text)",marginBottom:5}}>Cuerpo editable de Reserva</div>
                    ...
                    {(!bloquesLoading||bloquesReserva.length>0)&&<ReservaBloquesPanel bloques={bloquesReserva} onUpdate={onUpdateBloqueReserva} onMove={onMoveBloqueReserva} clausulasLib={clausulas} operaciones={operaciones} puedeEditar={puedeEditarPlantillas}/>} 
                  </div>}
                </div>}
              </div>
