  ...
  return(
    <div>
      ...
      <div className="grid2">
        ...
        <Slt label="Moneda de la reserva" value={data.res_alq_moneda||"ARS"} onChange={function(e){onChange("res_alq_moneda",e.target.value);}}><option value="ARS">ARS — Pesos argentinos</option><option value="USD">USD — Dólares estadounidenses</option></Slt>
        ...
        <Slt label="Moneda del alquiler" value={data.res_alq_monto_mensual_moneda||"ARS"} onChange={function(e){onChange("res_alq_monto_mensual_moneda",e.target.value);}}><option value="ARS">ARS — Pesos argentinos</option><option value="USD">USD — Dólares estadounidenses</option></Slt>
        <div className="col2"><div className="notice" style={{fontSize:11.5}}>La moneda de la reserva y la moneda del alquiler son independientes. Ejemplo: reserva en USD y contrato de alquiler en ARS.</div></div>
...
function getResumenMonto(op){
  if(op.tipo==="alquiler"||op.tipo==="reserva_alquiler"){
    ...
    var moneda = op.alquiler_moneda||op.res_alq_monto_mensual_moneda||op.res_alq_moneda||"ARS";
...
function EstadisticasView({operaciones,equipo,perfil,currentUserId,currentUserRole}){
  ...
  function comisionOperacion(o){
    ...
    if(tipo==="reserva"||tipo==="boleto"){
      ...
      base=parseFloat(o.res_alq_monto_mensual||0); moneda=o.res_alq_monto_mensual_moneda||o.res_alq_moneda||"ARS";
